...
/** 默认的列数 */
static const CGFloat CIDefaultColumnCount = 2;
/** 每一列之间的间距 */
static const CGFloat CIDefaultColumnMargin = 10;
/** 每一行之间的间距 **/
static const CGFloat CIDefaultFRowMargin = 10;
/** 内边距  */
static const UIEdgeInsets CIDefaultEdgeInsets = {10,10,10,10};
 
@interface VMWaterFallLayout()
...
@implementation VMWaterFallLayout
...
- (void)prepareLayout {
    ...
    for (NSInteger i = 0; i < self.columnCount; i++) {
        [self.columnHeights addObject:@(CIDefaultEdgeInsets.top)];
    }
...
- (UICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)indexPath attribute:(UICollectionViewLayoutAttributes*)attrs{
